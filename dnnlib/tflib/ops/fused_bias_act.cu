...
REGISTER_OP("FusedBiasAct").Input("x: T").Input("b: T").Input("ref: T").Output("y: T").Attr("T: {float, int32}").Attr("grad: int = 0").Attr("axis: int = 1").Attr("act: int = 0").Attr("alpha: float = 0.0").Attr("gain: float = 1.0");
